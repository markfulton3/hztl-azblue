...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.azblue.localhost/ --auth https://id.azblue.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.azblue.localhost/ --auth https://id.azblue.localhost/ --allow-write true
}
...
Start-Process https://cm.azblue.localhost/sitecore/
Start-Process https://www.azblue.localhost/
