...
Add-HostsEntry "cm.azblue.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.azblue.localhost"
}
Add-HostsEntry "id.azblue.localhost"
Add-HostsEntry "www.azblue.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.azblue.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.azblue.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.azblue.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.azblue.localhost"
